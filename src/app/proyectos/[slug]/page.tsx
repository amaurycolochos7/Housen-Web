                ...
                <div className="container-custom">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div className="lg:col-span-2 order-2 lg:order-1">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mb-8">
                                {project.features.map((feature, index) => (
                                    <div key={index} className="flex items-start gap-2 bg-white p-3 rounded-lg border border-gray-100">
                                        <svg className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                        </svg>
                                        <span className="text-[var(--housen-dark)] text-sm">{feature}</span>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="lg:col-span-1 order-1 lg:order-2">
                            <div className="lg:sticky lg:top-28 bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                                <h3 className="text-xl font-semibold text-[var(--housen-dark)] mb-4">
                                    ¿Te interesa este proyecto?
                                </h3>
                                <p className="text-[var(--housen-gray)] mb-6 text-sm">
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-[var(--housen-dark)] font-medium text-right">{project.location}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
